...
function drawArrowToCanvas(context) {
    ...
    if((Math.abs(parseInt(yFactor)) == 13 && Math.abs(parseInt(xFactor)) == 6 ) || 
        (Math.abs(parseInt(yFactor)) == 6 && Math.abs(parseInt(xFactor)) == 13 )) {

        context.lineTo(initialPoint.x, finalPoint.y);
        context.lineTo(finalPoint.x, finalPoint.y);
        context.stroke();
        drawArrow(context, initialPoint.x, finalPoint.y, finalPoint.x, finalPoint.y, arrowWidth);
